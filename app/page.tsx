        ...
        <section className="relative -mt-1 bg-gradient-to-r from-accent via-[#e74c3c] to-accent animate-gradient overflow-hidden">
          <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 relative z-10">
            <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
              ...
              <Button 
                className="bg-white text-accent hover:bg-white/90 transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-0.5 relative z-10" 
                asChild
              >
                <Link href="/edukasi">
                  Pelajari Sekarang
            ...
            <div className="animate-marquee flex gap-8 whitespace-nowrap py-4">
              ...
              {rupiahImages.map((src, index) => (
                ...
                >
                  <Image 
                    src={src} 
                    alt={`Spesimen Rupiah Emisi 2022 Pecahan ke-${index + 1}`}
                    fill
